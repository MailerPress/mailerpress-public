            ...
            throw new \InvalidArgumentException(
                esc_html(
                    \sprintf(
                        ...
                        __('The provided template directory does not exist: %s', 'mailerpress'),
                        esc_url($directory)
                    )
                )
            );
            ...
            throw new \RuntimeException(
                esc_html(
                    \sprintf(
                        ...
                        __('Template file not found: %s', 'mailerpress'),
            ...
            throw new \RuntimeException(
                esc_html(
                    \sprintf(
                        ...
                        __('An error occurred while rendering the template: %s', 'mailerpress'),
